...
BASE = '/Users/xiaojinzhao/Documents/GitHub/encoding-pack-size/pack-size-for-icde27'
...
_ICDE27 = os.path.dirname(os.path.abspath(__file__))
if _ICDE27 not in sys.path:
    sys.path.insert(0, _ICDE27)
from integer_datasets import INTEGER_DATASET_MAPPING
