    ...
    for filename in os.listdir(output_dir):
        if filename in dataset_mapping:
            ...
            try:
                ...
                sprintz_only_prune_plus_results[filename] = {'compression_ratio': round(df_rl['Compression Ratio'].values[0], 3), 'encoding_time': df_rl['Encoding Time'].values[0], 'decoding_time': df_rl['Decoding Time'].values[0]}
            except Exception:
                pass
            try:
            ...
            try:
                ...
                sprintz_search_results[filename] = {'compression_ratio': round(df_rl['Compression Ratio'].values[0], 3), 'encoding_time': df_rl['Encoding Time'].values[0], 'decoding_time': df_rl['Decoding Time'].values[0]}
            except Exception:
                pass
            try:
                df_rl = pd.read_csv(os.path.join(output_dir_sprintz, filename))
                sprintz_results[filename] = {'compression_ratio': round(df_rl['Compression Ratio'].values[0], 3), 'encoding_time': df_rl['Encoding Time'].values[0], 'decoding_time': df_rl['Decoding Time'].values[0]}
            except Exception:
                pass
            try:
                df_rl = pd.read_csv(os.path.join(output_dir_sprintz_rmq, filename))
                sprintz_rmq_results[filename] = {'compression_ratio': round(df_rl['Compression Ratio'].values[0], 3), 'encoding_time': df_rl['Encoding Time'].values[0], 'decoding_time': df_rl['Decoding Time'].values[0]}
            except Exception:
                pass
            try:
                df_rl = pd.read_csv(os.path.join(output_dir_sprintz_n2, filename))
                sprintz_n2_results[filename] = {'compression_ratio': round(df_rl['Compression Ratio'].values[0], 3), 'encoding_time': df_rl['Encoding Time'].values[0], 'decoding_time': df_rl['Decoding Time'].values[0]}
            except Exception:
                pass
            try:
            ...
            try:
                ...
                sprintz_only_prune_results[filename] = {'compression_ratio': round(df_rl['Compression Ratio'].values[0], 3), 'encoding_time': df_rl['Encoding Time'].values[0], 'decoding_time': df_rl['Decoding Time'].values[0]}
            except Exception:
                pass
